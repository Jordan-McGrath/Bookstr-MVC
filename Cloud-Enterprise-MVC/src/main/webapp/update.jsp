...
<body>
	<h1 class="container text-center" style="font-style: italic;">
		“We don’t make mistakes. We just have happy accidents"<br>Bob
		Ross
	</h1>
	<div class="container">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea class="form-control" id="synopsis"
					name="synopsis">${book.synopsis}</textarea><br>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
